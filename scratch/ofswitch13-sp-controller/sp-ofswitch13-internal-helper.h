...
#ifndef SPOFSWITCH13_INTERNAL_HELPER_H
#define SPOFSWITCH13_INTERNAL_HELPER_H
 ...
 */
class SPOFSwitch13InternalHelper : public OFSwitch13InternalHelper
{
public:
  SPOFSwitch13InternalHelper ();          //!< Default constructor.
  virtual ~SPOFSwitch13InternalHelper (); //!< Dummy destructor, see DoDispose.
  ...
  void CreateOpenFlowChannels (std::vector<int> ctIdv);
  void CreateOpenFlowChannelsV2 (std::vector<int> ctIdv);
...
#endif /* SPOFSWITCH13_INTERNAL_HELPER_H */
